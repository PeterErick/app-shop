        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h5 class="description">Puedes revisar nuestra relación completa de productos, comparar precios y realizar tus pedidos cuando esteés seguro.</h5>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Atendemos rápidamente cualqueir consulta que tengas vía chat. No estás solo, sino que siempre estamos atentos a tus inquietudes.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Los pedidos que realices sólo los conoceras tú a través de tu panel de usuario. Nadie más tiene acceso a esta información.</p>
                        </div>
                    </div>
                </div>
            </div>
